...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-zinc-50 via-blue-50/30 to-blue-50/20 dark:from-zinc-950 dark:via-blue-950/10 dark:to-blue-950/10 py-24 md:py-32 lg:py-40">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-5xl mx-auto">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 bg-blue-600/10 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-900 text-blue-700 dark:text-blue-300 px-5 py-2.5 rounded-full text-sm font-semibold mb-8 backdrop-blur-sm">
            ...
            {/* Subheadline */}
            <p className="text-xl sm:text-2xl text-zinc-600 dark:text-zinc-400 max-w-3xl mx-auto mb-12 leading-relaxed font-light">
      ...
      {/* Stats Section */}
      <section className="py-20 border-y border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900">
      ...
      <section
        id="features"
        className="py-24 md:py-32 bg-zinc-50 dark:bg-zinc-950"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Section Header */}
      ...
      <section className="py-16 bg-zinc-50 dark:bg-zinc-950 border-y border-zinc-200 dark:border-zinc-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-zinc-600 dark:text-zinc-400 font-semibold text-sm uppercase tracking-wider mb-6">
            ...
            <div className="flex flex-wrap justify-center gap-8">
              {certifications.map((cert, index) => (
                <div
                  key={index}
                  className="px-6 py-3 bg-white dark:bg-zinc-900 border-2 border-zinc-200 dark:border-zinc-800 rounded-lg font-semibold text-zinc-900 dark:text-white"
                >
                  {cert}
                </div>
              ))}
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button
              ...
              href="/auth/register"
              size="lg"
              className="bg-white text-blue-600 font-semibold shadow-2xl hover:bg-zinc-50 px-10 h-14 text-base"
              endContent={<ArrowRight className="h-5 w-5" />}
            >
                ...
                {socialLinks.map((social, index) => {
                  ...
                  return (
                    <Link
                      key={index}
                      href={social.href}
                      className="w-10 h-10 rounded-lg bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center text-zinc-400 hover:text-white transition-all"
